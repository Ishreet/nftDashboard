		...
		<Card>
			...
			<List disablePadding>
				...
				>
					...
					>
						{t('Reported time-off leave')}: 21-27 March
						2022
					</Typography>
				</ListItem>
				...
				>
					<Box display="flex" alignItems="center">
						<ListItemAvatar>
							<Avatar src="/images/avatars/3.jpg" />
						</ListItemAvatar>
						<ListItemText
					...
					>
						{t('Cancelled the scheduled consult set for')}
						: 21 March 2021
					</Typography>
				</ListItem>
				<Divider component="li" />
				...
				>
					...
					>
						{t('Reported time-off leave')}: 02-18 February
						2021
					</Typography>
				</ListItem>
			</List>
