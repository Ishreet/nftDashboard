				...
				<Grid item xs={12} sm={6} md={5} lg={4}>
					<CardIndicatorWrapper>
						...
						>
							<img
								style={{ height: '30px' }}
								src="/images/placeholders/logo/netflix-logo.jpg"
								alt="..."
							/>
							<Typography
								variant="h3"
								...
								gutterBottom
							>
								Mainframe Analytics Cluster for
				...
				<Grid item xs={12} sm={6} md={5} lg={4}>
					<CardIndicatorWrapper>
						...
						>
							<img
								style={{ height: '30px' }}
								src="/images/placeholders/logo/google-logo.jpg"
								alt="..."
							/>
							<Typography
								variant="h3"
								...
								gutterBottom
							>
								Main Website Sales Monitoring Cluster
								Database
							</Typography>
							<Typography variant="subtitle2">
