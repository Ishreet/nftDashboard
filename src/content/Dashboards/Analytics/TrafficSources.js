	...
	const chartData = [
		{
			...
			type: 'column',
			data: [
				1008, 940, 1010, 821, 1035, 1030, 957, 926, 993, 1021,
				997, 879
			]
		},
		{
			...
			type: 'line',
			data: [
				648, 745, 897, 743, 635, 842, 811, 696, 878, 987, 747,
				731
			]
		}
	];
				...
				{currentTab === 'direct' && (
					...
					>
						...
						<Typography
							...
							gutterBottom
						>
							There are no charts generated for{' '}
							<b>Direct</b> traffic sources!
						</Typography>
						<Button
							variant="contained"
							sx={{
