...
const ListItemButtonWrapper = styled(ListItemButton)(
    ...
    &:hover {
        ...
        z-index: 9;
        box-shadow: 
            0 0.56875rem 2.3rem ${alpha(
				theme.colors.alpha.black[100],
				0.03
			)},
            0 0.9975rem 1.4rem ${alpha(
				theme.colors.alpha.black[100],
				0.04
			)},
            0 0.35rem .5rem ${alpha(
				theme.colors.alpha.black[100],
				0.05
			)},
            0 0.225rem 0.4rem ${alpha(
				theme.colors.alpha.black[100],
				0.07
			)};
    }
	...
	const items = [
		{
			...
			logo: '/images/placeholders/logo/discord-icon.svg',
			value: '4,685'
		},
		{
			id: 2,
			...
			category: 'Marketing',
			logo: '/images/placeholders/logo/google-icon.svg',
			value: '8,434',
			budget: 'over'
		},
		{
			...
			category: 'Bugfixes',
			logo: '/images/placeholders/logo/spotify-icon.svg',
			value: '5,167',
			budget: ''
		},
		{
			...
			category: 'Development',
			logo: '/images/placeholders/logo/slack-icon.svg',
			value: '43,584',
			budget: ''
		},
		{
			...
			category: 'Marketing',
			logo: '/images/placeholders/logo/pinterest-icon.svg',
			value: '5,978',
			budget: 'over'
		}
	];
					...
					>
						...
						<BoxComposedImage
							sx={{
								opacity: 0.3,
								backgroundImage:
									'url("/images/placeholders/covers/2.jpg")'
							}}
						/>
						<BoxComposedContent
							display="flex"
