				...
				<Grid item xs={12} md={4}>
					...
					>
						...
						<Link
							...
							color="text.primary"
						>
							Migrate hosting to a more performant web
							server datacenter
						</Link>
						<Box
							sx={{
						...
						>
							...
							layout beatae vitae dicta sunt explicabo.
						</Typography>
				...
				<Grid item xs={12} md={4}>
					...
					>
						...
						<Link
							...
							color="text.primary"
						>
							Improve conversion rated by integrating
							new analytics tools
						</Link>
						<Box
							sx={{
				...
				<Grid item xs={12} md={4}>
					...
					>
						...
						<Link
							...
							color="text.primary"
						>
							Increase the website speed on mobile and
							tablet devices
						</Link>
						<Box
							sx={{
						...
						>
							...
							accusantium doloremque laudantium voluptas
