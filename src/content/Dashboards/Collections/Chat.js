					...
					<Box px={2}>
						...
						>
							...
							>
								<CardWrapperSecondary>
									Hi. Can you send me the missing
									invoices asap?
								</CardWrapperSecondary>
								<Typography
									variant="subtitle1"
						...
						>
							...
							>
								...
								>
									How are you? Is it ok if I call
									you?
								</CardWrapperSecondary>
								<Typography
									variant="subtitle1"
						...
						>
							...
							>
								<CardWrapperPrimary>
									Hello, I just got my Amazon order
									shipped and I’m very happy about
									that.
								</CardWrapperPrimary>
								<CardWrapperPrimary
									sx={{
