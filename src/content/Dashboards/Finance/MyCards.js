...
function MyCards() {
	...
	const data = {
		logo1: '/images/placeholders/logo/deutschebank_light.svg'
	};
			...
			<List disablePadding>
				<ListItemWrapper>
					...
					>
						<img
							alt="Spotify"
							src="/images/placeholders/logo/spotify.svg"
						/>
					</ListItemAvatar>
					<ListItemText
						primary="Spotify"
				...
				<ListItemWrapper>
					...
					>
						<img
							alt="Slack"
							src="/images/placeholders/logo/slack.svg"
						/>
					</ListItemAvatar>
					<ListItemText
						primary="Slack"
				...
				<ListItemWrapper>
					...
					>
						<img
							alt="AirBnB"
							src="/images/placeholders/logo/airbnb.svg"
						/>
					</ListItemAvatar>
					<ListItemText
						primary="AirBnB"
			...
			>
				<AvatarGroup max={6}>
					...
					<Tooltip
						arrow
						title={
							t('View profile for') + ' Travis Howard'
						}
					>
						<Avatar
							component={Link}
					...
					<Tooltip
						arrow
						title={
							t('View profile for') + ' Agnes Walker'
						}
					>
						<Avatar
							component={Link}
