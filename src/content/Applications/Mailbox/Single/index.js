...
export const MailboxSingle = (props) => {
	const { mailId, tag } = props;
	const dispatch = useDispatch();
	const { user } = useAuth();
	const mailbox = useSelector(
		(state) => state.mailbox.mails.byId[mailId]
	);
	...
	return (
		<>
			...
			>
				...
				<Box>
					<Tooltip arrow placement="top" title={'Archive'}>
						<IconButton
							color="primary"
							sx={{
								ml: 1,
