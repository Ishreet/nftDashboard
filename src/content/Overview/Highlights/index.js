						...
						>
							...
							>
								<Box
									sx={{
										animation:
											'2.1s 2.1s infinite alternate ease-in-out float'
									}}
								>
									<ResourcesAlarm />
								</Box>
							...
							>
								<Box
									sx={{
										animation:
											'2.8s 1.2s infinite alternate ease-in-out float'
									}}
								>
									<ActiveReferrals />
								</Box>
							...
							>
								<Box
									sx={{
										animation:
											'2.1s 1.5s infinite alternate ease-in-out float'
									}}
								>
									<UnresolvedTickets />
								</Box>
							...
							>
								<Box
									sx={{
										animation:
											'3.5s 2.4s infinite alternate ease-in-out float'
									}}
								>
									<Transfers />
								</Box>
							...
							>
								<Box
									sx={{
										animation:
											'1.5s 1s infinite alternate ease-in-out float'
									}}
								>
									<Thermostat />
								</Box>
							...
							>
								<Box
									sx={{
										animation:
											'2.5s 3s infinite alternate ease-in-out float'
									}}
								>
									<RecentTransactions />
								</Box>
							...
							>
								<Box
									sx={{
										animation:
											'3s infinite alternate ease-in-out float'
									}}
								>
									<MonthlyGoalsTarget />
								</Box>
							...
							>
								<Box
									sx={{
										animation:
											'2s 2s infinite alternate ease-in-out float'
									}}
								>
									<AccountSecurity />
								</Box>
