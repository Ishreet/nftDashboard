			...
			>
				<Grid item md={6} pr={{ xs: 0, md: 3 }}>
					...
					>
						<MuiAvatar>
							<img
								src="/images/logo/material-ui.svg"
								alt="MUI (Material-UI)"
							/>
						</MuiAvatar>
						<Typography variant="h6">
							...
							>
								{' '}
								- A simple and customizable component
								library to build faster, beautiful,
					...
					<ListItemWrapper>
						...
						<Typography variant="h6">
							...
							>
								{' '}
								- Tokyo features a modern technology
								stack and is built with React +
								Javascript.
							</Typography>
						</Typography>
					</ListItemWrapper> */}
				...
				<Grid item md={6}>
					<BoxContent>
						<Link href="/collections/boredapetestingclub">
							<ImgWrapper>
								<img
									alt="Tokyo"
									src="/images/overview/hero-screenshot.png"
								/>
							</ImgWrapper>
						</Link>
						<BoxAccent
